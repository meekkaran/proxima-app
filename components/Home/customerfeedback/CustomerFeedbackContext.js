...
function CustomerFeedbackContext() {
  ...
  const [customerFeedbackPerPage] = useState(6);
  ...
  const indexOfLastCustomerFeedback = currentPage * customerFeedbackPerPage;
  const indexOfFirstCustomerFeedback =
    indexOfLastCustomerFeedback - customerFeedbackPerPage;
  const currentCustomerFeedbacks = customerfeedbacks.slice(
    indexOfFirstCustomerFeedback,
    indexOfLastCustomerFeedback
  );
  ...
  return (
    <>
      <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2'>
        {currentCustomerFeedbacks.map((customerfeedback) => (
            ...
            <div className='py-2'>
              ...
              <div className='py-1 px-2'>
                ...
                <div className='p-2 bg-gray-200 dark:text-black/60 rounded-md shadow-md text-sm'>
                  <p>{customerfeedback.user_summary} </p>
                </div>
              </div>
              {/* Agents summary */}
              <div className='py-1 px-2'>
                ...
                <div className='p-2 bg-gray-200 dark:text-black/60 rounded-md shadow-md text-sm'>
                  <p>{customerfeedback.agents_summary} </p>
                </div>
              </div>
              ...
              <div className='py-1 px-2'>
                ...
                <div className='p-2 bg-gray-200 dark:text-black/60 rounded-md shadow-md text-sm'>
                  <p>{customerfeedback.conversation_summary}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className='w-full pt-10 pb-5 flex justify-center'>
        <Pagination
          customerFeedbackPerPage={customerFeedbackPerPage}
          totalCustomerFeedback={customerfeedbacks.length}
          paginate={paginate}
...
const Pagination = ({
  customerFeedbackPerPage,
  totalCustomerFeedback,
  paginate,
  currentPage,
}) => {
  const pageNumbers = [];
  ...
  for (
    let i = 1;
    i <= Math.ceil(totalCustomerFeedback / customerFeedbackPerPage);
    i++
  ) {
    pageNumbers.push(i);
  }
