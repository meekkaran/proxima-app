...
function CumulativeTrends() {
  ...
  return (
    <div className='flex flex-col p-1 py-2 outline outline-1 outline-gray-300 dark:outline-gray-100 rounded-md shadow-md'>
      ...
      <div className='flex-col pt-2  text-center'>
        <h1 className='text-4xl text-black text-center m-2'>
          {/* {averageinteractiontime?.average_interaction_time} */}
          min
        </h1>
