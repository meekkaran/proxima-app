...
function Newstatus() {
  ...
  return (
    <div className='outline outline-1 outline-gray-300 rounded-md shadow-md'>
      <h1 className='text-center text-3xl text-blue-900 dark:text-white/80 py-2 font-bold'>
      ...
      <div className='flex flex-col sm:flex-row rounded-sm'>
        <div className='flex-col pt-2 bg-gray-100  text-center'>
          <h1 className='text-4xl text-black dark:text-white/80'>
