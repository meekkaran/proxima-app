...
export const selectCumulativeHourlyChats = (state) =>
  state.analytics.cumulativehourlychats;
export const SelectHourlyCountEscalatedIssues = (state) =>
  state.analytics.hourlyescalatedissues;
export const selectMostPopularTopics = (state) =>
  state.analytics.mostpopulartopics;
export const SelectHourlychats = (state) => state.analytics.hourlychats;
export const SelectHourlyQueriesReceived = (state) =>
  state.analytics.hourlyqueriesreceived;
export const SelectCountEscalatedissues = (state) =>
  state.analytics.totalescalatedissues;
